  ...
  <main class="min-h-screen flex items-center justify-center pt-20">
    <div
      ...
      <div
        ...
        <div
          class="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-black/30"></div>
        <div class="relative z-10 p-12 text-left max-w-md">
          <h3 class="text-4xl font-extrabold tracking-tight">
            <span style="font-family: Fjalla One">SOLA <span class="text-purple-700">ROXA</span></span>
          </h3>
          ...
          <div class="mt-6 relative">
            ...
            <form id="login-form" class="space-y-4">
              ...
              <div class="flex items-center justify-between text-sm">
                <a href="javascript:void(0)" class="text-white/60 hover:text-roxa transition">Esqueceu sua senha?</a>
