...
<html lang="pt-br">
  <head>
    ...
    <meta
      name="description"
      content="Sola Roxa — Luxury urban sneakers marketplace inspired by Golden Goose."
    />
    <!-- Fonts -->
    <link
      ...
      <section class="mb-10">
        ...
        <div class="mb-8">
          <div class="relative">
            ...
            />
            <button
              class="absolute right-4 top-1/2 -translate-y-1/2 text-white/70 hover:text-roxa transition"
            >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          ...
          <div class="bg-black/70 border border-white/10 rounded-xl p-4">
            <h3
              class="font-semibold mb-3 flex items-center gap-2 cursor-pointer"
            >
          ...
          <!-- Cor -->
          <div
            class="bg-black/70 border border-white/10 rounded-xl p-4"
            data-filter="cor"
          >
            <h3
              class="font-semibold mb-3 flex items-center gap-2 cursor-pointer"
            >
              <i data-lucide="palette"></i>COR
              <i data-lucide="chevron-down" class="ml-auto"></i>
            </h3>
            <div class="space-y-2">
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  class="rounded text-roxa focus:ring-roxa"
                />
                <span>Preto</span>
              </label>
              <label class="flex items-center gap-2 cursor-pointer">
          ...
          >
            <h3
              class="font-semibold mb-3 flex items-center gap-2 cursor-pointer"
            >
              <i data-lucide="layers"></i>MATERIAL
              <i data-lucide="chevron-down" class="ml-auto"></i>
            </h3>
            <div class="space-y-2">
              <label class="flex items-center gap-2 cursor-pointer">
          ...
          <div
            class="bg-black/70 border border-white/10 rounded-xl p-4"
            data-filter="fechamento"
          >
            <h3
              class="font-semibold mb-3 flex items-center gap-2 cursor-pointer"
            >
              <i data-lucide="link"></i>TIPO DE FECHAMENTO
              <i data-lucide="chevron-down" class="ml-auto"></i>
            </h3>
            <div class="space-y-2">
              <label class="flex items-center gap-2 cursor-pointer">
          ...
          <div
            class="bg-black/70 border border-white/10 rounded-xl p-4"
            data-filter="caracteristicas"
          >
            <h3
              class="font-semibold mb-3 flex items-center gap-2 cursor-pointer"
            >
              <i data-lucide="list"></i>CARACTERÍSTICAS
              <i data-lucide="chevron-down" class="ml-auto"></i>
            </h3>
            <div class="space-y-2">
              <label class="flex items-center gap-2 cursor-pointer">
          ...
          >
            <h3
              class="font-semibold mb-3 flex items-center gap-2 cursor-pointer"
            >
              <i data-lucide="activity"></i>TIPOLOGIA DE USO
              <i data-lucide="chevron-down" class="ml-auto"></i>
            </h3>
            <div class="space-y-2">
              <label class="flex items-center gap-2 cursor-pointer">
          ...
          <div
            class="bg-black/70 border border-white/10 rounded-xl p-4"
            data-filter="edicao-limitada"
          >
            <h3 class="font-semibold mb-3 flex items-center gap-2">
              <i data-lucide="badge"></i>EDIÇÃO LIMITADA
              <div class="ml-auto">
                <label class="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" class="sr-only peer" />
                  <div
                    class="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-roxa"
                  ></div>
                </label>
              </div>
            </h3>
    ...
    <footer class="bg-black border-t border-white/10 mt-16">
      ...
      >
        ...
        <div class="flex gap-6">
          ...
          <a href="#" class="text-white/70 hover:text-roxa transition"
            >Privacy</a
          >
          <a href="#" class="text-white/70 hover:text-roxa transition"
            >Support</a
      ...
      async function loadProducts() {
        try {
          ...
          data.products.forEach((p) => {
            ...
            card.className = 'card-hover fade-in bg-white rounded-2xl overflow-hidden border border-gray p-5 flex flex-col items-center relative';
