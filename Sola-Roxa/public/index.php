...
<html lang="pt-br">
  <head>
    ...
    <meta
      name="description"
      content="Sola Roxa — Urban, premium sneakers marketplace inspired by editorial fashion."
    />
  ...
  <body class="bg-[#090909] text-white font-sans antialiased leading-normal">
    ...
    >
      ...
      >
        ...
        >
          <li>
            <a class="hover:text-roxa transition" href="#lancamentos"
              >Lançamentos</a
            >
          </li>
          <li>
    ...
    <section id="hero" class="relative h-screen w-full overflow-hidden">
      ...
      >
        <source
          src="assets/videos/videohalloweensnekaer.mp4"
          type="video/mp4"
        />
        <!-- fallback image -->
        <img
          src="assets/img/carroussel/nike-o-fenomeno-jordan.jpg"
          alt="Sneakers urbanos"
      ...
      <div
        class="relative z-10 max-w-6xl mx-auto px-6 sm:px-8 h-full flex flex-col justify-center"
      >
        <div class="max-w-3xl">
          <h1
            class="text-5xl md:text-7xl font-extrabold tracking-tight leading-tight opacity-0"
            id="hero-title"
          >
            <span class="text-orange-400">THE</span>
            <span style="font-family: 'Metal mania', sans-serif">SPOOKY</span>
            <span class="text-purple-800">DROP</span>
          </h1>
          <p class="mt-6 text-gray-300 max-w-xl opacity-0" id="hero-sub">
            Misture o medo com o estilo. Edição limitada inspirada na noite mais
            sombria do ano.
          </p>
          ...
          <div class="mt-1 flex flex-wrap gap-1 opacity-0" id="hero-ctas">
            <a
              href="#masculino"
              class="inline-flex items-center px-1 py-3 text-white rounded-md font-semibold hover:scale-[1.02] transition underline hover:text-roxa transition"
              >Para Ele</a
            >
            <a
              href="#feminino"
              class="inline-flex items-center px-6 py-3 text-white rounded-md font-semibold hover:scale-[1.02] transition underline hover:text-roxa transition"
              >Para Ela</a
            >
            <a
              href="#historias"
              class="inline-flex items-center px-1 py-3 text-sm text-white hover:text-roxa transition"
              >Saiba Mais</a
            >
          </div>
        </div>
    ...
    <section id="lancamentos" class="max-w-7xl mx-auto px-6 sm:px-8 py-20">
      ...
      <div class="relative">
        ...
        <div
          id="featured"
          class="flex gap-6 overflow-x-auto scrollbar-hide snap-x snap-mandatory scroll-smooth py-2"
        >
          <!-- sample cards -->
          <article
    ...
    <section id="colecoes" class="max-w-7xl mx-auto px-6 sm:px-8 py-20">
      <h2
        class="text-2xl font-bold mb-6 bg-gradient-to-r from-purple-300 to-white bg-clip-text text-transparent"
      >
        Coleções
      </h2>
      ...
      >
        <div class="flex-1">
          ...
          <div class="mt-8 flex flex-wrap gap-4">
            ...
            <a
              href="#"
              class="px-6 py-3 border border-white/20 text-white rounded-md hover:bg-white/5 transition-all duration-300"
        ...
        <div class="w-full md:w-1/3">
          <div
            class="bg-white/[0.02] backdrop-blur-sm rounded-md p-6 border border-white/10"
          >
      ...
      >
        <div class="max-w-3xl">
          ...
          <div class="mt-8 flex flex-wrap gap-4 opacity-0" id="hero-ctas">
            <a
              href="https://www.youtube.com/watch?v=CJaQ6_gadr0"
              target="_blank"
              class="inline-flex items-center px-6 py-3 bg-teal-400 text-black rounded-md font-semibold hover:scale-[1.02] transition"
              >Descubra a Coleção</a
            >
            <a
              href="https://www.reebok.com.br/club-c"
    ...
    <section id="sobre-sola-roxa" class="bg-white py-20 px-6 lg:px-20">
      <!-- Título -->
      <h2
        class="text-3xl lg:text-4xl font-extrabold text-gray-900 mb-12 uppercase tracking-wide"
      >
      ...
      >
        <div>
          <i
            data-lucide="truck"
            class="w-6 h-6 mx-auto text-purple-600 mb-3"
          ></i>
